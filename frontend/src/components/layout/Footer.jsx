    ...
    <footer className="bg-slate-900 text-slate-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold text-white">Mashroo3i</span>
            </div>
            <p className="text-sm leading-relaxed">AI-powered business planning platform for Jordanian entrepreneurs.</p>
          </div>
          <div>
        ...
        <div className="border-t border-slate-800 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">&copy; 2024 Mashroo3i. All rights reserved.</p>
