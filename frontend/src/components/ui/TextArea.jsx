    ...
    <div className={`${className}`}>
      ...
      <textarea
        ...
        className={`
          ...
          placeholder:text-gray-500 dark:placeholder:text-gray-500 resize-none
          transition-all duration-200
          focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500
          ${error ? 'border-red-300 focus:ring-red-500/10 focus:border-red-500' : 'border-gray-300 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-600'}
        `}
        {...props}
      />
      {error && (
