const ScenarioCard = ({ title, value, unit = '', color = 'indigo', icon, subtitle }) => {
  const colorMap = {
    ...
    slate:  { bg: 'bg-gray-50  dark:bg-gray-900/50',  text: 'text-gray-700  dark:text-gray-300',  icon: 'text-gray-500'  },
  }
  ...
  return (
    <div className={`rounded-xl p-4 ${c.bg}`}>
      ...
      <p className="text-xs font-medium text-gray-500 dark:text-gray-300 mb-1">{title}</p>
