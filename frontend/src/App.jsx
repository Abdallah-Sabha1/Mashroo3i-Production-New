        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
          <div className="max-w-md text-center">
            ...
            <button
              ...
              className="px-6 py-3 bg-primary-600 text-gray-50 rounded-lg hover:bg-primary-700 transition-colors font-medium"
            >
              Reload Page
            </button>
            {process.env.NODE_ENV === 'development' && (
              <details className="mt-6 text-left">
                ...
                <pre className="mt-2 p-2 bg-gray-100 dark:bg-gray-800 rounded text-xs overflow-auto max-h-40 text-gray-700 dark:text-gray-300">
