      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        {pageError && (
          <div className="mb-6 rounded-xl border border-red-200 dark:border-red-800
            bg-white dark:bg-gray-800 p-4 flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300">{pageError}</p>
              <button
                onClick={loadData}
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center justify-around gap-8 px-5 py-8">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="text-xs text-center text-gray-400 dark:text-gray-500 max-w-[130px]">
                ...
                <div className="space-y-3">
                  {recommendations.map((rec, i) => (
                    <div key={i} className="flex items-start gap-3">
                      <span className="w-5 h-5 rounded-full bg-gray-100 dark:bg-gray-800
